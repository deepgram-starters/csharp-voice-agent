...
help:
	@echo "C# Voice Agent - Available Commands"
	@echo "===================================="
	@echo ""
	@echo "Setup:"
	@echo "  make check-prereqs     Check for required tools (git, dotnet)"
...
check-prereqs:
	...
	@command -v dotnet >/dev/null 2>&1 || { echo "❌ dotnet is required but not installed. Visit https://dotnet.microsoft.com"; exit 1; }
